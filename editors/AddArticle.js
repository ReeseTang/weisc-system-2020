        ...
        return(
            <KeyboardAvoidingView style={{flex: 1, backgroundColor: '#fff'}} behavior='padding'>
                <ScrollView style={styles.body}>
                    ...
                    <View style={styles.rowCon}><Text style={{marginTop: 10}}>Abstract:</Text><Text style={styles.txtrequired}> *</Text></View>
                    ...
                    <View style={styles.rowCon}><Text style={{marginTop: 10}}>Introduction:</Text><Text style={styles.txtrequired}> *</Text></View>
                    <TextInput placeholder='Introduce your work here!' returnKeyType='none' onBlur={()=> this.setState({txt5: false})} multiline
                    ...
                    <View style={styles.rowCon}><Text style={{marginTop: 10}}>Methods:</Text><Text style={styles.txtrequired}> *</Text></View>
                    ...
                    <View style={styles.rowCon}><Text style={{marginTop: 10}}>Reference:</Text><Text style={styles.txtrequired}> *</Text></View>
