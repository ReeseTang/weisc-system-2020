...
import { View, Text, StyleSheet, KeyboardAvoidingView, ScrollView,
         Modal, ActivityIndicator, TextInput, Alert, Picker, Keyboard } from 'react-native';
            ...
            <KeyboardAvoidingView style={{flex: 1, backgroundColor: '#fff'}} behavior='padding' >
                ...
                <ScrollView style={{flex: 1}}>
                    <View style={styles.body}>
                        <Text style={{fontSize: 16, marginTop: 5, color: 'blue'}}>Report Any Suspected Case of Epidemic around you.</Text>
                        ...
                        <Text style={{marginTop: 10}}>Your Work:</Text>
                        <View style={{borderRadius: 5, borderColor: 'gray',borderWidth: 1, justifyContent: 'center', alignContent: 'stretch'}}>
                            <Picker style={{borderColor: 'gray', borderWidth: 1, borderRadius: 5,}} selectedValue={this.state.reporter_work}
                                onValueChange={(item, index) => this.setState({reporter_work: item}) }>
                                <Picker.Item  label='Student' value='Student' />
                                <Picker.Item  label='Self Employed' value='Self Employed' />
                                <Picker.Item  label='Public Sector' value='Public Sector' />
                        ...
                        <TextInput placeholder='Enter location of the report (Country, State, Town, Street, House)' returnKeyType='none' ref='5' onBlur={() => this.setState({textfield5: false})}
                        ...
                        <TextInput placeholder='Describe the Symptoms shown by the person' returnKeyType='none' ref='6' onBlur={() => this.setState({textfield6: false})}
                        ...
                        <TextInput placeholder='Describe what you know about the person(Name, Gender, Age) and the person current situation' returnKeyType='none' ref='7' onBlur={() => this.setState({textfield7: false})}
        ...
        if(isValid == true){
            ...
            fetch(url, {
                ...
                body: JSON.stringify({
                    ...
                    reporter_work: '' + this.state.reporter_work,
